...
bool Tracking::TrackWithMotionModel()
{
    ...
    if(sMaxLKPoints < 0)
    {
        ...
        sNccTh  = 0.75f;
        sPnpRep = 3.0f;
        // Tuned on TUM RGB-D: SearchByProjection matches usually lie in 100-200+,
        // so a low gate never fires (th=25 => LK unused). th=200 => ~20% of
        // frames trigger LK with ~50% adoption and <2% runtime overhead.
        sMMTh   = 200;
        const char* penv;
